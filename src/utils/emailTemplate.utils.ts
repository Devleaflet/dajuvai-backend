...
export const generateContactEmailHTML = (dto: ContactInput) => {
    ...
    <div style="max-width: 650px; margin: 20px auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 6px 18px rgba(0,0,0,0.08); font-family: Arial, sans-serif;">
      ...
      <!-- Header -->
      <div style="background: linear-gradient(135deg, #4cafef, #0077b6); color: #ffffff; text-align: center; padding: 25px;">
        <h1 style="margin: 0; font-size: 22px; font-weight: bold;">📩 New Contact Submission</h1>
        <p style="margin: 8px 0 0; font-size: 14px; opacity: 0.9;">A visitor just submitted the form</p>
      </div>
      ...
      <div style="padding: 25px;">
        ...
        <!-- Message -->
        <div style="margin-top: 20px; padding: 15px; background-color: #f1f8ff; border-left: 4px solid #0077b6; border-radius: 6px; line-height: 1.6;">
          ${dto.message}
        </div>
      </div>
