...
export const updateVendorSchema2 = z.object({
  ...
  // ADD THIS - profilePicture was missing from the v2 update schema!
  profilePicture: z
    .string()
...
export const updateVendorPaymentOptionSchema = z
  .object({
...
export type IUpdateVendorPaymentOptionRequest = z.infer<
  typeof updateVendorPaymentOptionSchema
>;
